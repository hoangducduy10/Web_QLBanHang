    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item ${lists.number == 0 ? 'disabled' : ''}">
                <a class="page-link" href="/san-pham/index?page=${lists.number - 1}">Previous</a>
            </li>
                ...
                <c:choose>
                    <c:when test="${page == 0 || page == lists.totalPages - 1 || (page >= lists.number - 1 && page <= lists.number + 1)}">
                        <li class="page-item ${page == lists.number ? 'active' : ''}">
                            <a class="page-link" href="/san-pham/index?page=${page}">${page + 1}</a>
                        </li>
                    </c:when>
                    <c:otherwise>
            ...
            <li class="page-item ${lists.number == lists.totalPages - 1 ? 'disabled' : ''}">
                <a class="page-link" href="/san-pham/index?page=${lists.number + 1}">Next</a>
            </li>
        </ul>
    </nav>
